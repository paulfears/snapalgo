...
declare type FetchContentTypes = 'text' | 'json' | 'arrayBuffer';
declare type FetchReturnType<T extends FetchContentTypes> = T extends 'text' ? string : T extends 'json' ? Json : T extends 'arrayBuffer' ? ArrayBuffer : never;
/**
 * @param url - The URL to fetch.
 * @param contentType - The content type of the response body.
 * @returns The response body as the specified content type.
 */
export declare function fetchContent<ContentType extends FetchContentTypes>(url: URL | string, contentType: ContentType, fetchFunction?: typeof fetch): Promise<FetchReturnType<ContentType>>;
/**
 ...
 */
export declare function fetchNpmSnap(packageName: string, version: string, registryUrl?: string, fetchFunction?: typeof fetch): Promise<SnapFiles>;
/**
