...
import { GetEndowments, GetPermissions, HasPermission, RequestPermissions, RevokeAllPermissions } from '../permissions';
...
export declare class SnapController extends BaseController<string, SnapControllerState, SnapControllerMessenger> {
     ...
     */
    private _lastRequestMap;
    private _maxIdleTime;
    private _maxRequestTime;
    private _rpcHandlerMap;
    private _snapsBeingAdded;
