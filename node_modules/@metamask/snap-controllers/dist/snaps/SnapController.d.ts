import { BaseControllerV2 as BaseController, GetEndowments, GetPermissions, HasPermission, HasPermissions, RequestPermissions, RestrictedControllerMessenger, RevokeAllPermissions, RevokePermissions } from '@metamask/controllers';
...
export declare type SnapControllerEvents = SnapAdded | SnapInstalled | SnapRemoved | SnapStateChange | SnapUpdated;
export declare type AllowedActions = GetEndowments | GetPermissions | HasPermission | HasPermissions | RevokePermissions | RevokeAllPermissions | RequestPermissions;
