...
export declare class SnapController extends BaseController<string, SnapControllerState, SnapControllerMessenger> {
    ...
    constructor({ closeAllConnections, executeSnap, getRpcMessageHandler, messenger, state, terminateAllSnaps, terminateSnap, endowmentPermissionNames, npmRegistryUrl, idleTimeCheckInterval, maxIdleTime, maxRequestTime, fetchFunction, featureFlags, }: SnapControllerArgs);
    /**
