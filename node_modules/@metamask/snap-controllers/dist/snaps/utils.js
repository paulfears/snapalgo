...
async function fetchNpmTarball(packageName, versionRange, registryUrl = exports.DEFAULT_NPM_REGISTRY, fetchFunction = fetch) {
    ...
    if (!(0, utils_1.isPlainObject)(packageMetadata)) {
        throw new Error(`Failed to fetch package "${packageName}" metadata from npm.`);
    }
    const targetVersion = (0, semver_1.maxSatisfying)(Object.keys((_a = packageMetadata === null || packageMetadata === void 0 ? void 0 : packageMetadata.versions) !== null && _a !== void 0 ? _a : {}), versionRange);
...
function createTarballExtractionStream(snapFiles) {
    ...
    extractStream.on('finish', () => {
        var _a, _b, _c, _d, _e;
        if ((0, utils_1.isPlainObject)(snapFiles.manifest)) {
...
function isValidSnapVersionRange(versionRange) {
    return Boolean(typeof versionRange === 'string' && (0, semver_1.validRange)(versionRange) !== null);
}
