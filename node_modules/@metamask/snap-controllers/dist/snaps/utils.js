 ...
 */
async function fetchNpmSnap(packageName, versionRange, registryUrl = exports.DEFAULT_NPM_REGISTRY, fetchFunction = exports.fetchContent) {
 ...
 */
async function fetchNpmTarball(packageName, versionRange, registryUrl = exports.DEFAULT_NPM_REGISTRY, fetchFunction = exports.fetchContent) {
    var _a, _b, _c, _d, _e;
    ...
    const targetVersion = semver_1.maxSatisfying(Object.keys((_b = (_a = packageMetadata) === null || _a === void 0 ? void 0 : _a.versions) !== null && _b !== void 0 ? _b : {}), versionRange);
...
function isValidSnapVersionRange(versionRange) {
    return Boolean(typeof versionRange === 'string' && semver_1.validRange(versionRange) !== null);
}
