...
class SnapController extends controllers_1.BaseControllerV2 {
    constructor({ closeAllConnections, executeSnap, getRpcMessageHandler, messenger, state, terminateAllSnaps, terminateSnap, environmentEndowmentPermissions = [], npmRegistryUrl, idleTimeCheckInterval = 5000, maxIdleTime = 30000, maxRequestTime = 60000, fetchFunction = globalThis.fetch.bind(globalThis), featureFlags = {}, }) {
        super({
            messenger,
            metadata: {
                snapErrors: {
    ...
    async _set(args) {
        ...
        const snap = {
            ...
            initialPermissions,
            manifest,
            permissionName: (0, utils_2.getSnapPermissionName)(snapId),
            sourceCode,
