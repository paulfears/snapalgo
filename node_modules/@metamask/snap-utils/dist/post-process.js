...
exports.postProcessBundle = void 0;
 ...
 */
function postProcessBundle(bundleString, { stripComments = true, transformHtmlComments = true, } = {}) {
    if (typeof bundleString !== 'string') {
        return null;
    }
    let processedString = bundleString.trim();
    if (stripComments) {
        processedString = (0, strip_comments_1.default)(processedString);
    }
