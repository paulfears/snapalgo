...
[![NPM version](https://img.shields.io/npm/v/@chainsafe/strip-comments.svg?style=flat)](https://www.npmjs.com/package/@chainsafe/strip-comments) 
[![NPM monthly downloads](https://img.shields.io/npm/dm/@chainsafe/strip-comments.svg?style=flat)](https://npmjs.org/package/@chainsafe/strip-comments) 
[![NPM total downloads](https://img.shields.io/npm/dt/@chainsafe/strip-comments.svg?style=flat)](https://npmjs.org/package/@chainsafe/strip-comments) 

> Strip line and/or block comments from a string. Blazing fast, and works with JavaScript, Sass, CSS, Less.js, and a number of other languages.

Fork of https://github.com/jonschlinkert/strip-comments with bunch of bugfixes required by Metamask Snaps.
