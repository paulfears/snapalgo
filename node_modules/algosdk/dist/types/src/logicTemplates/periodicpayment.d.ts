export class PeriodicPayment {
     ...
     */
    constructor(receiver: string, amount: any, withdrawalWindow: any, period: any, expiryRound: any, maxFee: any, lease: string);
    receiver: string;
    amount: any;
    withdrawalWindow: any;
    period: any;
    expiryRound: any;
    maxFee: any;
    lease: string;
 ...
 */
export function getPeriodicPaymentWithdrawalTransaction(contract: Uint8Array, fee: any, firstValid: any, genesisHash: string): any;
