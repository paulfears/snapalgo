export class DynamicFee {
     ...
     * @returns {DynamicFee}
     */
    constructor(receiver: string, amount: any, firstValid: any, lastValid: any, closeRemainder: string, lease: string);
    programBytes: any;
    address: string;
    /**
 ...
 */
export function getDynamicFeeTransactions(txn: any, lsig: any, privateKey: Uint8Array, fee: any): Uint8Array;
/**
